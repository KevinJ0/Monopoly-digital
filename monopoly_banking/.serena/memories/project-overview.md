...
## What is this?
A Flutter-based **Money Manager app** for playing the board game with digital money. Works **offline** (no internet needed) using:
...
## Audience
Spanish-speaking Money Manager players. All UI text and voice announcements are in Spanish.
