...
class BleBankPanel extends StatelessWidget {
  final VoidCallback? onShowDistanceSettings;
  final VoidCallback? onReiniciarBle;
  final VoidCallback? onStopBle;
  final Future<bool> Function(BleTransport transport)? onEnsureBleReady;

  const BleBankPanel({
    super.key,
    this.onShowDistanceSettings,
    this.onReiniciarBle,
    this.onStopBle,
    this.onEnsureBleReady,
  });
                        ...
                        SizedBox(
                          ...
                          child: active
                              ...
                              : ElevatedButton.icon(
                                  onPressed: () async {
                                    SoundService.playClick();
                                    final ready = await onEnsureBleReady
                                        ?.call(transport);
                                  ...
                                  icon: const Icon(
                                      ...
                                      size: 16),
                                  label:
                                      const Text('Iniciar Servidor BLE'),
